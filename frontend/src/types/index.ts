...
export type Decision = {email_id:string;thread_id:string;operation:string;skip_reason?:string;confidence:number;reasoning:string;evidence:string[];task?:{category:string;assignee_id:string;priority:string;company_name?:string;due_date?:string;deal_value_inr?:number}}
